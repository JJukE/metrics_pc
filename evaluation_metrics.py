# Reference: https://github.com/JRyanShue/NFD/blob/main/nfd/neural_field_diffusion/metrics/evaluation_metrics.py
import torch
import numpy as np
import warnings
...
# from lfd import LightFieldDistance # https://github.com/nv-tlabs/GET3D/tree/master/evaluation_scripts
...
#             print("sample_mesh.vertices: ", sample_mesh.vertices)
#             print("sample_mesh.faces: ", sample_mesh.faces)
#             print("ref_mesh.vertices: ", ref_mesh.vertices)
#             print("ref_mesh.faces: ", ref_mesh.faces)
#             lfd_lst.append(LightFieldDistance(verbose=1).get_distance(
